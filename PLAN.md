...
**Review checklist:**
- [ ] Both documents linked from registration/footer
- [ ] Privacy policy accurately describes the export/delete capabilities built in Phase 11
...
**Review checklist:**
- [ ] Overdue indicator disappears once a task is marked done
- [ ] Timezone handling doesn't cause off-by-one-day bugs (test near midnight)
...
**Review checklist:**
- [ ] Error boundary tested by deliberately throwing an error in a component
- [ ] Lighthouse accessibility score improvement noted
- [ ] Layout doesn't break at 375px and 768px widths
...
**Review checklist:**
- [ ] Deliberately break a test once and confirm the PR merge button is actually blocked
- [ ] Confirm staging deploy triggers automatically on merge
