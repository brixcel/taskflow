...
| **Tier 1: Media Engine** | **Phase 36** | **Optimized File & Image Attachments with Pre-Upload Compression**<br>• Task & comment file attachments (`POST /tasks/:id/attachments`)<br>• Browser HTML5 canvas pre-upload compression (WebP/JPEG 1920px, quality 0.8, 12MB → 250KB)<br>• Size caps (5MB max) & image preview drawer | ⏳ **NEXT** | `phase36-attachments.test.js` |
